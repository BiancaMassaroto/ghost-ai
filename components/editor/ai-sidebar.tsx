...
/**
 * Right-side slide-over placeholder for the future AI chat panel, per
 * `08-editor-workspace-shell.md`. Mirrors `ProjectSidebar`'s floating
 * overlay pattern, anchored to the right edge instead of the left. No AI
...
export function AiSidebar({ isOpen, onClose, className }: AiSidebarProps) {
  return (
    <aside
      ...
      inert={!isOpen}
      className={cn(
        "fixed top-14 bottom-0 right-0 z-40 flex w-96 flex-col border-l border-surface-border bg-surface/95 shadow-2xl backdrop-blur-sm transition-transform duration-200 ease-out",
