...
1. Keep the existing navbar behavior as-is.
   ...
   - if the editor home and editor canvas use the same navbar component, make sure this presence UI only appears in the canvas/editor room vieww
...
3. Render collaborator avatars.
   ...
   - show up to five collaborators avatars in an overlapping stack
...
## Scope Limits
    ...
    - don't add participant avatrs to the shared navbar globally
...
## Check When Done
    ...
    - Current user ir resolved from the active Clerk session.
