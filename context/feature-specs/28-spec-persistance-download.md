...
- link the recorde to the correct project
- follow the same metadata + blob pattern used for canvas persistance
...
- Prisma stores metadata, Vercel Blob store content
